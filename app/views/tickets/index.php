<div class="flex justify-between items-center mb-6">
    ...
    <a href="/tickets/create" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
            ...
            <?php foreach ($tickets as $ticket): ?>
                <tr class="hover:bg-gray-50">
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                        <?= htmlspecialchars($ticket['client_name'] ?? 'Unknown Client') ?>
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap">
                        <?php
                        $priorityColors = [
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                        <a href="/tickets/<?= $ticket['id'] ?>" class="text-indigo-600 hover:text-indigo-900 mr-3">View</a>
                        <a href="/tickets/<?= $ticket['id'] ?>/edit" class="text-indigo-600 hover:text-indigo-900 mr-3">Edit</a>
                        <form method="POST" action="/tickets/<?= $ticket['id'] ?>/delete" style="display: inline;">
                            <button type="submit" class="text-red-600 hover:text-red-900" onclick="return confirm('Are you sure you want to delete this ticket?')">Delete</button>
                        </form>
                    </td>
                </tr>
            <?php endforeach; ?>
